...
ALTER TABLE [dbo].[Piece]
    ADD CONSTRAINT [FK_PieceMarque] FOREIGN KEY ([MarqueId]) REFERENCES [dbo].[Marque] ([Id]);
...
--------------------------------------------------------------------------------------
*/
insert into Marque values ('GNK');
insert into Piece values ('Bougie de préchauffage');
GO
