...
GO
PRINT N'Création de Table [dbo].[Commande]...';
...
GO
PRINT N'Création de Table [dbo].[Commande_piece]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_Commande_T]...';


GO
ALTER TABLE [dbo].[Commande]
    ADD CONSTRAINT [FK_Commande_T] FOREIGN KEY ([UtilisateurId]) REFERENCES [dbo].[Utilisateur] ([Id]);


GO
PRINT N'Création de Clé étrangère [dbo].[FK_Commande_piece_ToCommande]...';


GO
ALTER TABLE [dbo].[Commande_piece]
    ADD CONSTRAINT [FK_Commande_piece_ToCommande] FOREIGN KEY ([CommandeId]) REFERENCES [dbo].[Commande] ([Numero]);


GO
PRINT N'Création de Clé étrangère [dbo].[FK_Commande_piece_ToPiece]...';


GO
ALTER TABLE [dbo].[Commande_piece]
    ADD CONSTRAINT [FK_Commande_piece_ToPiece] FOREIGN KEY ([PieceId]) REFERENCES [dbo].[Piece] ([Id]);


GO
PRINT N'Création de Clé étrangère [dbo].[FK_Photos_Piece]...';


GO
ALTER TABLE [dbo].[Photos]
    ADD CONSTRAINT [FK_Photos_Piece] FOREIGN KEY ([PieceId]) REFERENCES [dbo].[Piece] ([Id]);
...
GO
PRINT N'Création de Procédure [dbo].[CSP_AddCommande]...';


GO
CREATE PROCEDURE [dbo].[CSP_AddCommande]
	@Numero int,
	@status nvarchar(255),
	@date nvarchar(255),
	@UtilisateurId int
...
End
GO
PRINT N'Création de Procédure [dbo].[CSP_Commande]...';


GO
CREATE PROCEDURE [dbo].[CSP_Commande]
	@Numero int,
	@status nvarchar(255),
	@date nvarchar(255),
	@UtilisateurId int
